...
@unittest.skipIf(
    ...
    f"Skipping integration tests: {IMPORT_ERROR if not HAS_DEPENDENCIES else ''}",
)
class TestOllamaIntegration(unittest.TestCase):
                ...
                if models:
                    ...
                    for model in models:
                        if any(
                            ...
                            for name in ["llama3.1", "qwen2.5", "llama", "mistral"]
                        ):
    ...
    def test_chat_with_system_prompt(self):
        ...
        request = ChatRequest(
            ...
            system_prompt=SystemPrompt(
                content="You are a helpful math assistant. Answer concisely."
            ),
        )
    ...
    def test_error_handling_invalid_model(self):
        ...
        invalid_config = ProviderConfig(
            host="http://localhost:11434", default_model="nonexistent-model-12345", timeout=10.0
        )
