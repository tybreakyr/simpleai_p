...
class TestModels(unittest.TestCase):
    ...
    def test_provider_features(self):
        ...
        features = ProviderFeatures(structured_output=True, streaming=True, context_window=8192)
    ...
    def test_provider_config(self):
        ...
        config = ProviderConfig(
            host="http://localhost:8000", default_model="gpt-4", timeout=30.0, retry_attempts=3
        )
    ...
    def test_factory_config(self):
        ...
        provider_config = ProviderConfig(host="http://localhost", default_model="model")
        factory_config = FactoryConfig(
            default_provider="provider1", provider_configs={"provider1": provider_config}
        )
        ...
        with self.assertRaises(ValueError):
            FactoryConfig(
                default_provider="nonexistent", provider_configs={"provider1": provider_config}
            )
