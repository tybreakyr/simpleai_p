...
from llm_provider.models import FactoryConfig, Model, ProviderConfig
...
class TestFactory(unittest.TestCase):
    ...
    def test_create_provider(self):
        ...
        config = ProviderConfig(host="http://localhost", default_model="test-model")
    ...
    def test_load_config(self):
        ...
        config = FactoryConfig(
            ...
            provider_configs={
                "mock": ProviderConfig(host="http://localhost", default_model="test-model")
            },
        )
